<?php
/* Smarty version 3.1.30, created on 2016-12-08 08:29:05
  from "E:\wamp\www\1\aiboc\aiboc_admin\templates\building_list_edit_form.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58490bc1d73d15_53423289',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '00bdb2f0330f7a938f3fea75fcbc70bd32180741' => 
    array (
      0 => 'E:\\wamp\\www\\1\\aiboc\\aiboc_admin\\templates\\building_list_edit_form.tpl',
      1 => 1481108446,
      2 => 'file',
    ),
  ),
...
function content_58490bc1d73d15_53423289 (Smarty_Internal_Template $_smarty_tpl) {
?>
<ol class="breadcrumb" style="background-color:#e0dfe3 ; color: dodgerblue; font-family: Elephant">
    <h3>Building Registration Edit</h3>
</ol>
<div class="well">
    <div id="rescout"></div>
    <form method="post" action="building_list_update.php" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Location:</label>
                    <input type="text" name="rlocation" id="rlocation" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['getlocation']->value;?>
" placeholder="Building Location">
                </div>
                <div class="form-group">
                    <label>Place:</label>
                    <input type="text" name="rplace" id="rplace" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['getplace']->value;?>
" placeholder="Building Place">
                </div>
                <div class="form-group">
                    <label>State:</label>
                    <input type="text" name="rstate" id="rstate" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['getstate']->value;?>
" placeholder="State">
                </div>
                <div class="form-group">
                    <label>Pin:</label>
                    <input type="text" name="rpin" id="rpin" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['getpin']->value;?>
" placeholder="Pin Code">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="rcarpetarea" id="rcarpetarea" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['getcarpetarea']->value;?>
" placeholder="Carpet Area sqf">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="rmaincost" id="rmaincost" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['getmaincost']->value;?>
" placeholder="Maintance Cost">
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    <label>Address:</label>
                    <textarea rows="3" name="raddress" id="raddress" class="form-control"><?php echo $_smarty_tpl->tpl_vars['getaddress']->value;?>
</textarea>
                </div>
                <div class="form-group">
                    <label>Other Facilities:</label>
                    <textarea rows="3" name="rotherfaci" id="rotherfaci" class="form-control"><?php echo $_smarty_tpl->tpl_vars['getotherfeci']->value;?>
</textarea>
                </div>
                <div class="form-group">
                    <label>Any Conditions:</label>
                    <textarea rows="2" name="rconditions" id="rconditions" class="form-control"><?php echo $_smarty_tpl->tpl_vars['getconditions']->value;?>
</textarea>
                </div>
                <div class="form-group">
