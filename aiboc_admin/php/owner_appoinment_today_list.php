...
$columns = array(
    ...
    array( 'db' => 'owner_id',  'dt' => 2, 'formatter' => function($d){
        $getown = Owner::GetById($d);
        return $getown->name;
    }),
    array( 'db' => 'owner_id',  'dt' => 3, 'formatter' => function($d){
        $getown = Owner::GetById($d);
...
if(isset($_SESSION['CHANGE_DATE']))
{
    $fordate = $_SESSION['CHANGE_DATE'];
